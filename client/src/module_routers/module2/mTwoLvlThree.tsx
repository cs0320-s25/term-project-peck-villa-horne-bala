  ...
  return (
    <div>
      ...
      <p>
        ...
        <br></br>
        <strong>
          Task: In the format "x % y" find the remainder of 7 mod 3, 5 mod 
          1 and 4  mod 18. Also come up with your own way of getting the
          remainder 9. Print the result of each mod with commas in-between and think about what it means! Note: if
